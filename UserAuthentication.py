...
class UserAuthApp:
    def __init__(self):
        self.init_db()
        self.set_background_image("Images/back2.jpg")  # Replace with your main background image path
        self.set_sidebar_background("Images/side.png")  # Replace with your sidebar background image path
        self.TELEGRAM_TOKEN = "7047754135:AAG8fFEA1lDVe21bQYYTozv3gb_wpf3-5hs"
        self.TELEGRAM_CHAT_ID = "1893904443"
